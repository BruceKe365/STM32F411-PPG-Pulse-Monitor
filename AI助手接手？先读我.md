...
| Stress live 最终验证 | `training_dataset/reports/full_stress_live_validation_20260629_current/` |
...
| `training_dataset/reports/full_stress_live_validation_20260629_current/` | 按当前固件参数重算的压力 MCU live 回放报告。 |
